...
import ResetPasswordSuccessPage from "../modules/auth/pages/ResetPasswordSuccessPage";
...
export default function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path={ROUTES.RESET_PASSWORD_SUCCESS} element={<PublicRoute><ResetPasswordSuccessPage /></PublicRoute>} />
